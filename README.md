...
A browser-based fighting game inspired by Shadow Fight 2, built with Next.js, TypeScript, and Canvas/WebGL. Battle through a tournament of Sealers as you break free from chains and open the gate.

## Features

- **Shadow-style combat** — Articulated silhouette fighters with punches, kicks, roundhouses, rolls, blocks, and supers
- **Dynamic soundtrack** — Procedurally generated Chinese-inspired music (erhu, guzheng, dizi) that intensifies with combat
