...
// silhouette ridge from [x, h] points
function ridge(ctx: CanvasRenderingContext2D, pts: number[], color: string, baseY = GROUND_Y) {
  ctx.fillStyle = color;
  ctx.beginPath();
  ctx.moveTo(0, baseY);
  for (let i = 0; i < pts.length; i += 2) ctx.lineTo(pts[i], baseY - pts[i + 1]);
  ctx.lineTo(VIRTUAL_W, baseY);
  ctx.closePath();
  ctx.fill();
}
...
function drawSunset(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  ridge(ctx, [0, 70, 150, 110, 300, 70, 460, 120, 620, 80, 780, 120, 960, 90], "rgba(40,20,50,0.5)");
  ridge(ctx, [0, 40, 120, 80, 260, 45, 420, 90, 560, 50, 720, 95, 880, 55, 960, 70], "rgba(18,9,26,0.8)");
...
function drawDesert(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  // dunes
  ridge(ctx, [0, 30, 200, 70, 420, 30, 640, 80, 860, 40, 960, 60], "rgba(80,50,24,0.55)");
  ridge(ctx, [0, 20, 160, 50, 380, 24, 600, 60, 820, 30, 960, 44], "rgba(40,24,12,0.8)");
...
function drawTemple(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  ridge(ctx, [0, 30, 300, 60, 600, 30, 960, 55], "rgba(12,8,20,0.9)");
...
function drawBamboo(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  // distant ridges
  ridge(ctx, [0, 40, 220, 90, 460, 50, 700, 100, 960, 60], "rgba(10,28,20,0.7)");
  fireflies(ctx, eng);
...
function drawMoon(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  ridge(ctx, [0, 60, 200, 120, 380, 70, 560, 140, 760, 80, 960, 110], "rgba(10,16,36,0.6)");
  ridge(ctx, [0, 36, 180, 80, 360, 44, 540, 90, 740, 50, 960, 70], "rgba(6,10,24,0.85)");
...
function drawSnow(ctx: CanvasRenderingContext2D, eng: GameEngine) {
  ...
  ridge(ctx, [0, 50, 200, 110, 420, 60, 640, 130, 860, 70, 960, 90], "rgba(14,24,40,0.7)");
  snow(ctx, eng);
